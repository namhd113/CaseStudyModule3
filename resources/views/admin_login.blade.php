...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        <form action="{{route('admin-dashboard')}}" method="post">
            @csrf
            <input type="text" class="ggg" name="inputUsername" id="inputUsername" placeholder="Điền Email" required="">
            <input type="password" class="ggg" name="inputPassword" id="inputPassword" placeholder="Điền PASSWORD" required="">
            <span><input type="checkbox" />Nhớ tao</span>
